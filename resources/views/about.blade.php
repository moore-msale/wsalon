        ...
        <div class="row">
            <div class="col-md-7 col-12">
                ...
                <p class="font-raleway">
                    ...
                    <br>всё то что делает каждое платье уникальным и это всё то почему именно эти
                    <br>платья непременно оказываются на вешалках W салона. Мы привозим платья для
                    <br>пышных и скромных свадеб, для свадеб на природе и за границей. Остаётся
                    <br>лишь выбрать. Мы знаем что выбор не из легких и поэтому мы и наши дорогуши
                    <br>феечки выслушают тебя, помогут разобраться в ассортименте и предложат
                    <br>варианты, но выбор мы оставим только за тобой. Ты замечала эту лучезарную,
                    <br>заразительную и такую счастливую улыбку на своём лице каждый раз когда
                    <br>платье нравится и точка? Мы замечаем.
                </p>
        ...
        <div class="row">
            <div class="col-12">
                <p class="font-raleway">
                    ...
                    прекрасное время, когда родители
                    прислушиваются к своим детям, а дети открыты со своими родителями. К счастью мы смогли быть
                    свидетелями таких отношений с 2015,
                    разговаривая с вам, а иногда подслушивая ваши разговоры во время примерок в нашем старом салоне.
                    А начиная с 2019 мы расширились
                    переехав в более захватывающее и магическое место. Всё для того чтобы сам салон помогал вам
                    выборе, а мы могли слышать всё больше
                    крутых истории про взаимопонимание поколений.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-12 text-center pb-4">
                ...
                <p class="font-caveat position-absolute about-us-frame" style="transform: translate(50%,-145%); font-size: 24px;">
                    ...
                    <br>волшебство не заканчивается, ведь
            ...
            <div class="col-md-6 col-12">
                <p class="font-raleway">
                    ...
                    <br>свадебное платье было у каждой девочки своё. Каждая наша
                    <br>невеста вместе с платьем получает фирменный сундучок и
                    <br>вешалку, дизайн и форму которых мы продумывали с особой
                    <br>тщательностью. Ведь нам очень важно, чтобы она выдерживала вес
                    <br>как легкого, так и роскошного атласного платья. А также для того
                    <br>чтобы твоё платье так же любовало глаз на вешалке или в сундучке
                ...
                <p class="font-raleway">
                    ...
                    <br>помочь тебе во всём, не только в выборе платья, но также и
                    <br>посоветовав оформителей, фотографов, ведущих, всех тех кого мы
                    <br>знаем лично и уверены в их профессионализме.
                </p>
            </div>
        </div>
    </div>

...
<head>
    ...
    <meta property="og:image" content="{{asset(isset($seo->image) ?  'storage/'.$seo->image : 'images/wsalon-og.jpeg')}}" />
    <meta property="og:image:secure_url" content="{{asset(isset($seo->image) ?  'storage/'.$seo->image : 'images/wsalon-og.jpeg')}}" />
    <!-- Google Tag Manager -->

...
@foreach($dresses as $dress)
    <div class="col-sm-6 col-md-4 col-lg-4 item text-center pt-lg-4 pt-4 position-relative  " >
        <a href="{{ asset('storage/'.$dress->image)  }}" title="{{ $dress->title }}" class="dressimage "  data-fancybox="gallery">
            <img class="img-fluid w-100" src="{{ asset('storage/'.$dress->image)  }}">
            <div class="position-absolute bg-white shadow  " style="bottom: 0; width: 92%">
                <h4 class="ml-2 text-left" style="color: #3A3C51; ">{{ $dress->title }}</h4>
                <div  class="d-flex text-left">
                    <div class="mr-3 ml-2">
                        <p class="font-raleway" style="color: #3A3C51; font-size: 0.8rem;">Дизайнер</p>
                        <h5 class="font-raleway" style="color: #3A3C51; font-weight: 600;  font-size: 0.9rem;">{{ $dress->author->name }}</h5>
                    </div>
                    <div>
                         <p class="font-raleway" style="color: #3A3C51; font-size: 0.8rem;">Страна</p>
